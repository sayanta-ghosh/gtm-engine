...
def web() -> None:
    ...
    \b
    Search:  nrv web search "query"        (RapidAPI Google Search)
    Scrape:  nrv web scrape <url>           (Parallel.ai Extract)
    Crawl:   nrv web crawl <url>            (Parallel.ai Extract, multi-URL)
    Extract: nrv web extract <url> --prompt (Parallel.ai Task API)
    """
...
def search_web(
    ...
    \b
    Examples:
        nrv web search "Acme Corp funding"
        nrv web search "SaaS pricing" --site g2.com
        nrv web search "Mindtickle hiring" --time week
        nrv web search "AI startups" --country in --num 50
        nrv web search "site:linkedin.com/in CTO fintech"
    """
    _require_auth()
...
def bulk_search(
    ...
    \b
    Examples:
        nrv web bulk-search "Acme funding" "Acme hiring" "Acme reviews"
        nrv web bulk-search "competitor A pricing" "competitor B pricing"
    """
    _require_auth()
...
def scrape_page(
    ...
    Examples:
        ...
        nrv web scrape https://acme.com/pricing --objective "pricing tiers"
        nrv web scrape https://competitor.com/pricing --full-content --json-output
    """
    _require_auth()
...
def crawl_site(
    ...
    \b
    Examples:
        nrv web crawl https://acme.com/about https://acme.com/pricing
        nrv web crawl https://acme.com/team https://acme.com/careers \\
...
def extract_structured(
    ...
    Examples:
        ...
        nrv web extract https://acme.com/team \\
            --prompt "List all team members with name, title, and LinkedIn URL"
        nrv web extract https://acme.com/about \\
