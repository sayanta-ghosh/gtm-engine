...
def person(
    ...
    Examples:
        ...
        nrv enrich person --name "John Doe" --domain acme.com
        nrv enrich person --linkedin https://linkedin.com/in/johndoe
        nrv enrich person --email john@acme.com --reveal-phone
    """
    _require_auth()
...
def company(domain: str, provider: str | None, dry_run: bool) -> None:
    ...
    \b
    Examples:
        nrv enrich company --domain google.com
        nrv enrich company --domain https://www.acme.io
    """
    _require_auth()
